...
namespace AuthAPI.Services
{
    public class AuthAPIService : IAuthAPIService
    {
        ...
        public async Task<ResponseDto> Login(Dtos.LoginRequestDto loginRequestDto)
        {
        ...
        public async Task<ResponseDto> Register(Dtos.RegistrationRequestDto registrationRequestDto)
        {
